...
ruta_base = Path(r'C:\Users\apr.gestiondered6\Desktop\Automatizaciones\CuadrosRojos')
...
for i in range(cantidad_proyectos):
    try:
        ...
        try:
            df_inspeccion = pd.read_excel(archivo_excel, sheet_name='INSPECCIÓN', header=2)
